        ...
        <Transition.Root show={open} as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={setOpen}>
                <div className="flex items-end justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    <span className="hidden sm:inline-block sm:align-middle am:h-screen" aria-hidden="true">
                        &#8203;
                    </span>
                    <Transition.Child as={Fragment} enter="ease-out duration-300"
                    ...
                    leaveTo="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95">
                        ...
                        overflow-hidden shadow-xl transform transition-all sm:my-56 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                            {
                                selectedFile?(
                            ...
                            <div>
                                ...
                                <div className="mt-5 sm:mt-6">
                                    ...
                                    hover:disabled:bg-gray-300" onClick={uploadPost}>
